...
import com.example.amado.sounddroid.com.example.amado.sounddroid.soundcloud.SoundCloudService;
import com.example.amado.sounddroid.com.example.amado.sounddroid.soundcloud.Soundcloud;
...
public void updateTracks(List<Track> tracks){
    ...
    public boolean onQueryTextSubmit(String query) {
        ...
        Soundcloud.getService().searchSong(query, new Callback<List<Track>>() {
            @Override
            public void success(List<Track> tracks, Response response) {
                updateTracks(tracks);
            }
